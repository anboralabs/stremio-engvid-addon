...
import static co.anbora.labs.engvid.domain.constants.EnglishVideoConstantsHelper.DEFAULT_IMAGE;
...
public interface Plugin {
    ...
    String[] ID_PREFIXES = new String[] {StremioConstantsHelper.StremioCatalog.VIDEO_PREFIX_ID};
    String[] RESOURCES = new String[] {"catalog", "meta", "stream"};
    String[] TYPES = new String[] {"movie"};
    Catalog[] CATALOGS = new Catalog[] {
            new Catalog(StremioConstantsHelper.StremioCatalog.MOVIE, StremioConstantsHelper.StremioCatalog.BEGINNER_ID_CATALOG, "Beginner Lessons Catalog", new String[] {}, new String[0], new String[] {SEARCH}),
            new Catalog(StremioConstantsHelper.StremioCatalog.MOVIE, StremioConstantsHelper.StremioCatalog.INTERMEDIATE_ID_CATALOG, "Intermediate Lessons Catalog", new String[] {}, new String[0], new String[] {SEARCH}),
            new Catalog(StremioConstantsHelper.StremioCatalog.MOVIE, StremioConstantsHelper.StremioCatalog.ADVANCED_ID_CATALOG, "Advanced Lessons Catalog", new String[] {}, new String[0], new String[] {SEARCH})
    };
    String BACKGROUND = "";
