...
public class AddonRepositoryImpl implements IAddOnRepository {
  ...
  private Function<List<LessonInfo>, List<LessonInfoVO>>
      listLessonInfoToVOMapper;
  ...
  public AddonRepositoryImpl(
      Function<LessonMedia, LessonMediaVO> lessonMediaToVOMapper,
  ...
  public void save(LessonMedia lessonMedia) {
    this.lessonDao.updateMedia(lessonMediaToVOMapper.apply(lessonMedia));
  }

  @Override
  public void save(List<LessonInfo> lessons) {
    this.lessonDao.insert(listLessonInfoToVOMapper.apply(lessons));
  }

  @Override
  public List<Lesson> getLessons() {
    return listLessonVOMapper.apply(this.lessonDao.findAll());
  }
  ...
  public Lesson getLessonById(Integer lessonId) {
    return lessonVOMapper.apply(this.lessonDao.findById(lessonId));
  }
